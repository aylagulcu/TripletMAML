...
def main(
    ...
    PATH= "./Tripletmaml_"+str(selected_model)+ "_batchsize"+ str(meta_batch_size)+ "_shots"+ str(shots) + ".pt"
    random.seed(seed)
    np.random.seed(seed)
    ...
    f = open("./Tripletmaml_"+ str(selected_model)+"_batchsize"+ str(meta_batch_size)+ "_shots"+ str(shots) + ".csv", "w")
...
if __name__ == '__main__':
    ...
    #MINIIMAGENET
    #OMNIGLOT
    main(selected_model="MINIIMAGENET")